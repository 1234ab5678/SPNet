...
class StripPooling(nn.Module):
    ...
    def forward(self, x):
        ...
        x2_2 = self.conv2_1(self.pool1(x1))
        x2_3 = self.conv2_2(self.pool2(x1))
        x2_4 = self.conv2_3(self.pool3(x2))
        #print(x2_4.shape)
        x2_5 = self.conv2_4(self.pool4(x2))

        x2_2 = F.interpolate(x2_2, size=(h,w), mode='bilinear',align_corners=True)
        x2_3 = F.interpolate(x2_3, size=(h, w), mode='bilinear', align_corners=True)
        x2_4 = F.interpolate(x2_4, size=(h, w), mode='bilinear', align_corners=True)
        x2_5 = F.interpolate(x2_5, size=(h, w), mode='bilinear', align_corners=True)
