...
#from nets.models.fcn import FCNHead
from nets.customize import StripPooling

class SPNet(nn.Module):
    def __init__(self, num_classes, backbone, pretrained, norm_layer=nn.BatchNorm2d, spm_on=True):
        ...
        self.head = SPHead(2048, num_classes, norm_layer)
        #if aux:
